 ...
 * @author Alds
 */
@WebServlet(urlPatterns = {"/suggestionsServlet"})
public class suggestionsServlet extends HttpServlet {
    
    private SuggestionController controller = SuggestionController.getInstance();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet suggestionsServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet suggestionsServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        int id = controller.getMaxSuggestionID() + 1;
